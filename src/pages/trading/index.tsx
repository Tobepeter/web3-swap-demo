        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-gray-100 rounded">
            ...
            <div className="mb-4">
              ...
              <input type="number" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm" placeholder="0.0" readOnly />
              <select className="mt-2 block w-full rounded-md border-gray-300 shadow-sm">
                <option>MOCK_USDC</option>
                <option>MockERC20</option>
              </select>
            ...
            <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700">交换</button>
          </div>
        </div>
      </div>
    </div>
